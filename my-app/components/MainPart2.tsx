...
const MainPart2 = () => {
  return (
    <section className='h-full w-full xl:py-[100px] xl:px-[200px]  px-[40px] py-[20px] gap-[800px]'>
        ...
        <div className='xl:flex lg:flex  items-center   py-[100px] gap-[200x]  justify-center'>
            ...
            <div className='relative flex items-start xl:px-[40px] py-[50px]'>
                ...
                <h1 className='absolute flex items-center justify-center px-[100px] xl:py-[240px] py-[160px] xl:text-[60px] text-[50px]  font-bold text-white'>  HOW&nbsp;&nbsp;&nbsp;&nbsp;WE&nbsp;&nbsp;&nbsp;&nbsp;WORK</h1>
            </div>
        </div>

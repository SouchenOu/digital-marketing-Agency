...
const MainPart2 = () => {
  return (
    <section className='h-full w-full xl:py-[100px] xl:px-[500px]  px-[30px] py-[40px] gap-[800px]'>
        ...
        <div className='flex items-center justify-between px-[8px] py-[50px]'>
            <div className='bg-gradient-to-b from-black via-gray-800 to-black rounded-xl w-[500px] h-[350px]'>

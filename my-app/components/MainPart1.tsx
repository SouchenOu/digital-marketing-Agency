...
const MainPart1 = () => {
  return (
    <section className='border-2 border-red-700 flex items-start flex-col py-[30px] px-[80px] w-full gap-[20px]'>
        <div className='flex flex-col items-center justify-start gap-[20px] w-[600px]'>
